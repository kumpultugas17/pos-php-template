            ...
            <div class="col-lg-12">
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <button class="btn btn-sm btn-primary card-tools" style="margin-right: 2px;">Add New Products</button>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <table id="table_products" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                          ...
                          <tbody>
                            <?php
                            $products = query("SELECT * FROM products ORDER BY created_at DESC");
                            $no = 1;
